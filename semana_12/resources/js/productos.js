export default class Productos {
  ...
  /*
   * Completa el formulario con los datos del producto seleccionado
   * @param {String} idModal El identificador del cuadro de diálogo
   * @param {Object} rowData Los datos del producto seleccionado
   */
